...
import kr.ac.kku.cs.test_201821032.Key
import kr.ac.kku.cs.test_201821032.location.Url
import kr.ac.kku.cs.test_201821032.location.response.address.AddressInfoResponse
import kr.ac.kku.cs.test_201821032.location.response.search.SearchResponse
...
interface ApiService {
    ...
    suspend fun getSearchLocation(
        ...
        @Query("count") count: Int = 20,                   // 한 페이지에 얼만큼 보여주는지 명시
        @Query("searchKeyword") keyword: String,           // 검색어 기능
